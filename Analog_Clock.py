...
for i in range(1, 12983623, 1):
    ...
    hour_x = int(250 + r_hour * (math.cos((pi / 180) * (hour+120))))
    hour_y = int(250 + r_hour * (math.sin((pi / 180) * (hour+120))))
    ...
    pygame.draw.arc(display, (255, 255, 0), [200, 200, 94, 94], -(pi / 180) * ((hour/6) - 120), pi / 2, 3)
